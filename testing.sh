...
# 8. 'n' fuzztests generated by creator - all should generate unique solutions as indicated by print statements in output.
...
TEST5="./sudoku solve < /dev/null"
echo -e "\nTest 5: Testing invalid stdin format to solver module ($TEST5)" >> $FILE 2>&1
$TEST5 >> $FILE 2>&1
